...
export declare const contentGroup: string;
export declare const headerGroup: string;
export declare const mainContainer: string;
export declare const productSalesChart: string;
export declare const recentOrderTable: string;
export declare const titleTextContainer: string;
export declare const topSellingProductTable: string;
export declare const trendSection: string;
